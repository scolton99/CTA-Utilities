...
exports.get_destination_code = exports.validate_destination = exports.station_id = exports.uri_safe_station_id_map = exports.ServiceType = exports.Line = void 0;
var Line;
(function (Line) {
    Line["Red"] = "Red";
    Line["Orange"] = "Org";
    ...
    Line["Pink"] = "Pink";
    Line["Brown"] = "Brn";
    Line["PurpleExpress"] = "Pexp"; /* Appears only in Alerts, not Train Tracker */
})(Line = exports.Line || (exports.Line = {}));
var ServiceType;
(function (ServiceType) {
    ServiceType["SystemWide"] = "X";
    ServiceType["Rail"] = "R";
    ServiceType["Bus"] = "B";
    ServiceType["Train"] = "T";
...
exports.uri_safe_station_id_map = {
    "18th": 40830,
 ...
 */
var resolved_station = function (station, line) {
    var matching_stations = line_stations[line].filter(function (x) { return x[0] === station; });
    if (matching_stations.length === 0)
        return null;
 ...
 * @param line      The name of the line.
 */
exports.station_id = function (station, line) {
    var res = resolved_station(station, line);
    return res[1];
};
/**
 ...
 * @param line
 */
exports.validate_destination = function (destination, line) {
 ...
 * @param station
 */
exports.get_destination_code = function (destination, line, station) {
    if (static_destination_codes[line][destination])
        return static_destination_codes[line][destination];
    var res = resolved_station(station, line);
    return res[2];
};
//# sourceMappingURL=CTAData.js.map