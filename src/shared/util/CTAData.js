...
exports.getDestinationCode = exports.findPossibleLines = exports.validateDestination = exports.stationId = exports.uriSafeStationIdMap = exports.lineMap = exports.ServiceType = void 0;
var ServiceType;
(function (ServiceType) {
    ServiceType["SYSTEM_WIDE"] = "X";
    ServiceType["RAIL"] = "R";
    ServiceType["BUS"] = "B";
    ServiceType["TRAIN"] = "T";
 ...
 */
var resolvedStation = function (station, line) { return (lineStations[line].find(function (x) { return x[0] === station; })); };
/**
 ...
 * @param line      The name of the line.
 */
var stationId = function (station, line) {
    var res = resolvedStation(station, line);
    if (!res)
        return null;
    return res[1];
};
 ...
 */
var validateDestination = function (destination, line) {
    var found = destinations[destination];
    if (!found)
        return false;
 ...
 */
var findPossibleLines = function (destination) {
    var found = destinations[destination];
    if (!found)
        return null;
    return found;
};
exports.findPossibleLines = findPossibleLines;
/**
 *
 * @param destination   The human-readable destination (case-sensitive).
 ...
 * @param station       The name of the station.
 */
var getDestinationCode = function (destination, line, station) {
    var foundDestinationCodes = staticDestinationCodes[line];
    if (foundDestinationCodes) {
        var foundDestinationCode = foundDestinationCodes[destination];
...
exports.getDestinationCode = getDestinationCode;
